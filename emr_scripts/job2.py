...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_source', type=str, required=True,
                        help='Base URL for transformed input data (e.g., s3a://your-curated-bucket/transformed_data/ or /local/path/transformed_data/)')
    parser.add_argument('--output_url', type=str, required=True,
                        help='Base URL for analytics output data (e.g., s3a://your-consumption-bucket/analytics_output/ or /local/path/analytics_output/)')
